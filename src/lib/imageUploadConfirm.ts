 ...
 *
 * TODO: ConfirmDialog 검토 — 동기 boolean 반환이 필요해 native confirm 유지 중.
 *       호출부(tiptap-utils 등)를 async로 바꾸면 confirmSonner/ConfirmDialog로 교체 가능.
 */
export function confirmShrinkOversizedImage(file: File, maxBytes: number = MAX_BOARD_IMAGE_UPLOAD_BYTES): boolean {
