...
export default function AppShell({ children }: { children: React.ReactNode }) {
    ...
    const isStandalonePopupWindow = pathname === "/site-popup" || (pathname?.startsWith("/site-popup/") ?? false);
    ...
    return (
        <div className={styles.shellRoot}>
            <AdminModeBanner />
            <div className={`${styles.layout} ${sidebarOpen ? styles.layoutExpanded : styles.layoutCollapsed}`}>
                <button
                    type="button"
