...
export async function PUT(req: NextRequest, { params }: Params) {
    try {
        ...
        const res = await fetch(`${API_BASE_URL}/api/notice-boards/${noticeBoardSeq}/comments/${commentSeq}`, {
            method: "PUT",
            cache: "no-store",
            headers: {
        ...
        console.error("PUT /api/notice-boards/.../comments/[commentSeq] error =", error);
...
export async function DELETE(req: NextRequest, { params }: Params) {
    try {
        ...
        console.error("DELETE /api/notice-boards/.../comments/[commentSeq] error =", error);
